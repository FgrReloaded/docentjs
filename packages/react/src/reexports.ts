/**
 * Everything a react app needs from the lower-level packages, so one install and
...
export {
  ...
  type TargetSpec,
  type Theme,
  // `Tour` is the React component here; the tour definition type is `TourDefinition`.
