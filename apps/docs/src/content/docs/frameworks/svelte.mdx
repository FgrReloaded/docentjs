...
<LinkCard
  title="Pressroom — the Svelte example"
  href="/examples/svelte/"
  description="A newsroom desk with three tours, including replaced footer buttons and a popover component passed to useTour."
/>
